...
+
10. Select the *petstore* VPC for *Cluster VPC* (_Hint: Hover the mouse cursor over the VPCs in the drop-down to get a tooltip showing the VPC name_).
+
...
+
14. Under Load Balancing, select the Application Load Balancer and make sure *petstore-lb* is selected.

15. Set the *Health check grace period* to *300*. Note: This is the period of time, in seconds, that the Amazon ECS service scheduler should ignore unhealthy
